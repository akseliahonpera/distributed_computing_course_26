...
public class PatientModifyFrame extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger
            .getLogger(PatientModifyFrame.class.getName());
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(patientDataPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 555,
                                                Short.MAX_VALUE)
                                        .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(patientDataPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 231,
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws Exception {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (result.isSuccess()) {
            // TODO PatientTablen voisi päivittää näyttämään uuden patientin ilman että koko
            // listaa haetaan uudestaan
            // patientTable.updatePatient(patient); tän tyyppisesti
